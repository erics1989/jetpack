...
const wafSourceBlocks = [
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 14, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 13, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 14, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 12, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 11, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 7, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 5, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 7, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 5, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 6, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 9, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 15, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 11, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 14, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 13, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 12, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 11, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 10, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 1, 11, 4, 44 ) },
	{ rule: 1, timestamp: new Date( 2022, 9, 1, 11, 4, 44 ) },
];
...
const dataByDay = wafSourceBlocks.reduce( ( out, row ) => {
	const key =
		row.timestamp.getFullYear() + '-' + row.timestamp.getMonth() + '-' + row.timestamp.getDate();
	if ( ! out[ key ] ) {
		out[ key ] = 0;
	}
	out[ key ]++;
...
const chartData = Object.entries( dataByDay ).map( ( [ label, value ] ) => {
	return {
		label,
		value,
		nestedValue: null,
